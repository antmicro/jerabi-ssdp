...
/**
 * 
 * Represents a ssdp:update message.  This message is sent
 * when the device changes.  When a client receive this message, 
 * it must refresh his data on the device. 
 * 
 ...
 */
public class UpdateMessage extends AbstractSSDPNotifyMessage implements DeviceDescriptionMessage {
